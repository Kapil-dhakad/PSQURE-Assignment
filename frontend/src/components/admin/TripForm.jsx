...
const TripForm = ({ onClose, tripToEdit = null }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-[1000]">
      <div className="w-[946px] h-[508px] bg-white rounded-3xl p-14 flex flex-col gap-6 shadow-[0_6px_30px_rgba(0,0,0,0.15)]">
        ...
        <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
          ...
          <div className="flex gap-6">
            <div className="flex flex-col">
              ...
              <input
                ...
                required
                className="w-[403px] h-[50px] border border-[#e0e0e0] rounded-lg px-4 text-sm text-[#333] bg-[#fafafa] outline-none"
              />
            </div>
          ...
          <div className="flex justify-center gap-4 mt-2">
            <button
              type="button"
              onClick={onClose}
              className="w-[180px] bg-gray-200 hover:bg-gray-300 text-gray-700 text-[15px] font-medium rounded-lg py-3 transition"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="w-[180px] bg-blue-600 hover:bg-blue-700 text-white text-[15px] font-medium rounded-lg py-3 transition"
            >
