...
const CheckoutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="max-w-6xl mx-auto py-10 px-6 flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="space-y-3">
              <label
                className={`flex items-center gap-3 rounded-md px-3 py-2 border ${
                  paymentMethod === "card" ? "bg-blue-50 border-blue-100" : "border-gray-200"
                } cursor-pointer`}
                onClick={() => setPaymentMethod("card")}
              >
                <span
                  className={`w-4 h-4 rounded-full border flex items-center justify-center ${
                    paymentMethod === "card" ? "bg-white ring-2 ring-blue-400" : "bg-white"
                  }`}
                >
                  {paymentMethod === "card" ? (
              ...
              <label
                className={`flex items-center gap-3 rounded-md px-3 py-2 border ${
                  paymentMethod === "wallet" ? "bg-blue-50 border-blue-100" : "border-gray-200"
                } cursor-pointer`}
                onClick={() => setPaymentMethod("wallet")}
              >
                <span
                  className={`w-4 h-4 rounded-full border flex items-center justify-center ${
                    paymentMethod === "wallet" ? "bg-white ring-2 ring-blue-400" : "bg-white"
                  }`}
                >
          ...
          <div className="text-sm text-gray-700 space-y-4">
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="text-right text-gray-900">
                {seatCount > 0 ? selectedSeats.join(", ") : "—"}
              </div>
            </div>
          </div>
